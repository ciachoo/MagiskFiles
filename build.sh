...
edit_magisk_files() { 
$repl_command "s|topjohnwu/MagiskManager/update/|stangri/MagiskFiles/master/updates/|" Magisk/MagiskManager/app/src/main/java/com/topjohnwu/magisk/asyncs/CheckUpdates.java && \
